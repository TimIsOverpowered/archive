...
```bash
npx tsx scripts/import-tenants.ts <streamer_id> "postgresql://user:pass@host:5432/dbname"
```

**Example:**

```bash
npx tsx scripts/import-tenants.ts moonmoon "postgresql://archive_moonmoon:password@95.217.201.55:5432/moonmoon"
```
