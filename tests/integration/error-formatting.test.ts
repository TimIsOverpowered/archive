...
import { TenantNotFoundError, VodNotFoundError } from '../../src/utils/domain-errors.ts';
import { badRequest, HttpError, internalServerError } from '../../src/utils/http-error.ts';
