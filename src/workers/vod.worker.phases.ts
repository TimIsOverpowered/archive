...
import { getStrategy } from '../services/platforms/strategy.ts';
import { DOWNLOAD_METHODS, type DownloadMethod, PLATFORMS, SOURCE_TYPES } from '../types/platforms.ts';
import { createAutoLogger } from '../utils/auto-tenant-logger.ts';
import { initRichAlert, updateAlert } from '../utils/discord-alerts.ts';
import { PlatformNotConfiguredError } from '../utils/domain-errors.ts';
import { extractErrorDetails } from '../utils/error.ts';
import { fileExists, getTmpDirPath, getTmpFilePath } from '../utils/path.ts';
import type { StandardVodJob } from './jobs/types.ts';
import { enqueueFinalizeJob } from './jobs/youtube.job.ts';
import type { BaseWorkerContext } from './types.ts';
import type { VodWorkerAlerts } from './utils/alert-factories.ts';
...
import { downloadVodWithFfmpeg } from './vod/vod-download-strategies.ts';
