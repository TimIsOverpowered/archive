...
import { registerTenantConfigSubscriber } from '../config/tenant-config-subscriber.ts';
import { Server } from '../constants.ts';
import { registerCacheSubscriber, registerGameCacheSubscriber } from '../services/cache-invalidator.ts';
import { createErrorContext, formatErrorResponse } from '../utils/error.ts';
import { createLogger, getLogger, setGlobalLogger } from '../utils/logger.ts';
import createTenantLoggerMiddleware, { exitTenantContext } from './middleware/tenant-logger.ts';
import configPlugin from './plugins/config.plugin.ts';
import redisPlugin from './plugins/redis.plugin.ts';
import { errorResponse } from './response.ts';
import { default as adminRoutes, tenantsRoutes as adminTenantsRoutes, authRoutes } from './routes/admin/index.ts';
import allTenantsVodsRoutes from './routes/all-tenants-vods.ts';
...
import publicTenantsRoutes from './routes/tenants.ts';
import vodsRoutes from './routes/vods.ts';
